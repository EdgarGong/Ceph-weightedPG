...
# Modify this part to reconfigure if the build directory already exists
if [ -e $BUILD_DIR ]; then
    echo "'$BUILD_DIR' already exists; reconfiguring with CMake."
    cd $BUILD_DIR
else
    mkdir $BUILD_DIR
    cd $BUILD_DIR
...
# Run cmake even if the build directory exists
